                ...
                {clientes.length === 0 ? (
                    <div className="p-10 text-center">
                        <div className="w-12 h-12 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-3">
                            <FiUserX className="text-slate-300" size={24} />
                        </div>
                        <h3 className="text-sm font-bold text-slate-900">No hay clientes inactivos</h3>
                        <p className="text-slate-500 text-[11px] max-w-xs mx-auto mt-0.5">¡Buen trabajo! Todos tus clientes han tenido actividad reciente.</p>
                    </div>
                ) : (
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-1">
                                            {(() => {
                                                if (!cliente.ultima_cita) return null;
                                                try {
                                                  return (
